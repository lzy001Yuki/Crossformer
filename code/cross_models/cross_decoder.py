...
class DecoderLayer(nn.Module):
    '''
    The decoder layer of code, each layer will make a prediction at its scale
    '''
...
class Decoder(nn.Module):
    '''
    The decoder of code, making the final prediction by adding up predictions at each scale
    '''
